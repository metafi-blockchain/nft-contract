...
contract EnteralKingDomERC721Test is Test {
    ...
    function setUp() public {
        ...
        erc721 = new EnteralKingDomERC721(owner, "MyNFT", "MNFT");
    ...
    function test_mintBatchNFT() public {
        // Revert mint if id is already minted
        vm.prank(owner);
        ...
        uris[0] = "https://www.google.com";
        uris[1] = "https://www.google.com";
        erc721.mintBatchNFT(recipients, uris);
